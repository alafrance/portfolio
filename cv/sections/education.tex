...
\subtext{\textbf{Web} (Vue.js, Nuxt, Node.js, PostgreSQL), \textbf{Machine Learning} (Python, Pandas, Numpy, Matplotlib, Scikit-Learn, Keras), \\ \textbf{Bas Niveau} (C, C++, Rust), \textbf{Devops} (Docker, Kubernetes)}
\begin{zitemize}
...
\subtext{\textbf{Web} (Vue.js, Nuxt, Node.js, PostgreSQL), \textbf{Machine Learning} (Python, Pandas, Numpy, Matplotlib, Scikit-Learn, Keras), \\ \textbf{Low Level} (C, C++, Rust), \textbf{Devops} (Docker, Kubernetes)}
\begin{zitemize}
