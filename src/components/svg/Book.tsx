...
export default function Book({ref, className}: {ref: Ref<SVGSVGElement>, className?: string}) {
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" ref={ref}
      ...
      <rect x="5" y="2" width="15" height="20" fill="white"/>
      <path d="M10 2V10L13 7L16 10V2" fill="#DE3325"/>
      <path d="M10 2V10L13 7L16 10V2" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      <path
