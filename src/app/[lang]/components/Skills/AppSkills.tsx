...
export default function AppSkills({t, className}: { t: TranslationDictionary, className?: string}) {
  return (
    <section className={cn("bg-background-variant", className)} id={"skills"}>
      <h1 className={"text-center mt-4 mb-18"}>{t.navbar.skills}</h1>
      <div className={"grid grid-cols-3 lg:grid-cols-8 gap-x-0 gap-y-24 xl:gap-y-18 justify-items-center max-w-xl lg:max-w-5xl mx-auto"}>
